...
android {
    namespace = "com.example.chatbuzzzz"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.example.chatbuzzzz"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"
...
//        implementation("com.google.firebase:firebase-messaging:20.1.7")
        ...
        implementation ("com.google.firebase:firebase-messaging:23.0.0") // Use the appropriate version
